    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a
            href="#about"
            className="text-sm font-medium text-gray-700 hover:text-freeness-blue transition-colors"
          >
            About
          </a>
          <a
          ...
          <Button
            variant="ghost"
            className="text-sm font-medium text-gray-700 hover:text-freeness-blue"
          >
            Login
          </Button>
