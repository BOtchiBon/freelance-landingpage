  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden pt-20">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-10 -left-20 w-72 h-72 bg-freeness-blue-soft/30 rounded-full mix-blend-multiply blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-freeness-orange-soft/20 rounded-full mix-blend-multiply blur-3xl animate-float" style={{ animationDelay: "4s" }}></div>
      </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto flex flex-col md:flex-row gap-3 mb-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <Input
              ...
              className="rounded-md border-gray-300 focus:border-freeness-purple focus:ring-freeness-purple"
            />
            <Button 
              type="submit"
              className="bg-freeness-purple hover:bg-freeness-purple-dark text-white px-6"
            >
              Join the Movement
            </Button>
          </form>
          ...
          <div className="flex items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full bg-freeness-purple-light flex items-center justify-center text-xs text-white">TF</div>
              <div className="w-8 h-8 rounded-full bg-freeness-blue-soft flex items-center justify-center text-xs text-gray-700">JM</div>
              <div className="w-8 h-8 rounded-full bg-freeness-peach-soft flex items-center justify-center text-xs text-gray-700">SK</div>
            </div>
