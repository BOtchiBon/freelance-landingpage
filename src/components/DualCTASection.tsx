    ...
    <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          {/* Find Talent */}
          <div className="relative overflow-hidden rounded-2xl p-8 md:p-10 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-white to-freeness-cyan-soft/30 border border-gray-100">
            <div className="absolute top-0 right-0 w-20 h-20 bg-freeness-cyan-soft/20 rounded-full blur-2xl"></div>
            
            <div className="relative z-10">
              <div className="bg-freeness-cyan-soft/30 w-16 h-16 rounded-xl flex items-center justify-center mb-6">
