      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-freeness-purple transition-colors">
                <Linkedin size={20} />
              </a>
              <a href="#" className="text-gray-400 hover:text-freeness-purple transition-colors">
                <Instagram size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-freeness-purple transition-colors">
                  How to Hire
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                <MapPin size={16} className="text-freeness-purple" />
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-gray-500 hover:text-freeness-purple text-sm">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-500 hover:text-freeness-purple text-sm">
              Terms of Service
